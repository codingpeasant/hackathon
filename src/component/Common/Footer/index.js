...
import logo from '../../../assets/img/wayfair_logo.png'
...
const FooterData = [
    {
        ...
        links: [
            ...
            { linkTitle: "Order Tracking", link: "/empty-cart" },
    ...
    },
    {
        title: "SHOP",
        links: [
            { linkTitle: "My Orders", link: "/cart" },
            { linkTitle: "My Account", link: "/cartTwo" },
            { linkTitle: "Track My Order", link: "/order-tracking" },
            { linkTitle: "Sell on Wayfair", link: "/checkout-one" },
            { linkTitle: "Return Policy", link: "/checkout-two" },
            { linkTitle: "Help Center", link: "/wishlist" }
        ]
    }
]
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-12 col-sm-12 col-12">
                            <div className="footer_left_side">
                                ...
                                <p>
                                    <strong>Wayfair Inc.</strong>is an American e-commerce company based in Boston, Massachusetts that sells furniture and home goods online.
                                </p>
