                        ...
                        <div className="col-lg-12">
                            <div className="tabs_center_button">
                                <ul className="nav nav-tabs">
                                    <li><a data-toggle="tab" href="#new_arrival" className="active">Sale</a></li>
                                    <li><a data-toggle="tab" href="#trending">Deal of the Day</a></li>
                                    <li><a data-toggle="tab" href="#best_sellers">Furniture</a></li>
                                    <li><a data-toggle="tab" href="#featured">Outdoor</a></li>
                                    <li><a data-toggle="tab" href="#on_sall">Bedding & Bath</a></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-12">
